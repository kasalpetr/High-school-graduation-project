...
<body>
   <div id="main">
    <form action="php/pridatprodukt_insert.php" method="post" enctype="multipart/form-data" class="container">
        <input type="text" placeholder="Zadej název produktu" name="nazev" id="nazev_pridatprodukt">
        <input type="text" placeholder="Zadej cenu produktu" name="cena" id="cena_pridatprodukt">
        <textarea type="text" placeholder="Zadej popis produktu" name="popis" id="popis_pridatprodukt"> </textarea>
        <select name="typ" id="typ_pridatprodukt" >
    ...
    <div style="margin-bottom:30px"> 
        <input type="file" accept = "image/png, image/jpeg" name="obrazek" id="obrazek_pridatprodukt">
        <button id="pridatprodukt">Přidat produkt</button>
        </div>
