...
<body>
   <div id="main">
    <form action="php/pridatdruh_insert.php" method="post" class="container">
        <input type="text" placeholder="Zadej název" name="nazev" id="nazev_pridatprodukt">
        <input type="text" placeholder="Zadej zkratku" name="zkratka" id="cena_pridatprodukt">
        <div style="margin-bottom:30px"> 
            <button button id="pridatprodukt">Přidat druh</button>
